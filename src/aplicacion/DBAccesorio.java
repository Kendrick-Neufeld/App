 ...
 * @author Usuario
 */
public class DBAccesorio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 350, 110, 40));
    ...
    private void dbaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbaseActionPerformed
        DBAccesorio dbView = new DBAccesorio();
        dbView.sql = this.sql;
    ...
    public void deleteSelectedItem(String ID){
        ...
        String query = "Delete from Accesorio where AccID = "+ID;
        try{
    ...
    public void CargarArticuloBuscado(String ID){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from Accesorio where AccID = "+ID;
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBAccesorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DBAccesorio().setVisible(true);
            }
        });
    }
