 ...
 * @author Usuario
 */
public class DBModelo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tablas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Color", "Capacidad", "Tamaño", "Marca"
            }
        ));
        ...
        selectTableCombobox.setSelectedIndex(3);
        ...
        modLabel.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        modLabel.setForeground(new java.awt.Color(27, 47, 59));
        modLabel.setText("Modelo");
        jPanel1.add(modLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 230, 40));
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 410, 110, 40));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 350, 110, 40));
    ...
    public void deleteSelectedItem(String nombre){
        ...
        String query = "Delete from Modelo where ModNombre = '"+nombre+"'";
        try{
    ...
    public void CargarArticuloBuscado(String Nombre){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from Modelo where ModNombre = '"+Nombre+"'";
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
