 ...
 * @author Usuario
 */
public class DBBrand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        marcaLabel.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        marcaLabel.setForeground(new java.awt.Color(27, 47, 59));
        marcaLabel.setText("Marca");
        jPanel1.add(marcaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 230, 40));
        ...
        selectTableCombobox.setSelectedIndex(4);
    ...
    public void deleteSelectedItem(String nombre){
        ...
        String query = "Delete from Marca where MarcaNombre = '"+nombre+"'";
        try{
    ...
    public void CargarArticuloBuscado(String nombre){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from Marca where MarcaNombre = '"+nombre+"'";
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBBrand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
