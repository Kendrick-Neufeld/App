 ...
 * @author Usuario
 */
public class DBCliente extends javax.swing.JFrame {
    ...
    public DBCliente(Statement sql) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        clienteLabel.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        clienteLabel.setForeground(new java.awt.Color(27, 47, 59));
        clienteLabel.setText("Cliente");
        jPanel1.add(clienteLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 230, 40));
        ...
        selectTableCombobox.setSelectedIndex(9);
    ...
    private void dbaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbaseActionPerformed
        DBCliente dbView = new DBCliente();
        dbView.sql = this.sql;
    ...
    public void deleteSelectedItem(String nombre){
        ...
        String query = "Delete from Cliente where CliNombre = '"+nombre+"'";
        try{
    ...
    public void CargarArticuloBuscado(String nombre){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from Cliente where CliNombre = '"+nombre+"'";
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
