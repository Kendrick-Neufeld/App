 ...
 * @author Usuario
 */
public class DBDispositivoSuplidor extends javax.swing.JFrame {
    ...
    public DBDispositivoSuplidor() {
        initComponents();
        setLocationRelativeTo(null);
    }

    public DBDispositivoSuplidor(Statement sql) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        Tablas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Dispositivo", "Suplidor", "Precio", "Cantidad"
            }
        ));
        ...
        dispSupLabel.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        dispSupLabel.setForeground(new java.awt.Color(27, 47, 59));
        dispSupLabel.setText("Dispositivo Suplidor");
        jPanel1.add(dispSupLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 230, 40));
        ...
        selectTableCombobox.setSelectedIndex(8);
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 400, 110, 40));
        ...
        jPanel1.add(enterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 290, 110, 40));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 340, 110, 40));
    ...
    private void dbaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbaseActionPerformed
        DBDispositivoSuplidor dbView = new DBDispositivoSuplidor();
        dbView.sql = this.sql;
    ...
    public void deleteSelectedItem(String nombre){
        
        String query = "Delete from DispoSuplidor where SupID = (Select SupID from Suplidor where Supnombre = '"+nombre+"' )";
        try{
    ...
    public void CargarArticulo() {
        ...
        String query = "select * from DispoSuplidor";
        try {
    ...
    public void CargarArticuloBuscado(String nombre) {
        ResultSet res = null;
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from DispoSuplidor where SupID = (Select SupID from Suplidor where Supnombre = '"+nombre+"' )";
        try {
            res = sql.executeQuery(query);
        } catch (SQLException ex) {
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBDispositivoSuplidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DBDispositivoSuplidor().setVisible(true);
            }
        });
    }
