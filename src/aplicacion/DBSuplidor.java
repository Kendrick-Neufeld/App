 ...
 * @author Usuario
 */
public class DBSuplidor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tablas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Calle", "Sector", "Ciudad", "Pais", "Telefono"
            }
        ));
        ...
        selectTableCombobox.setSelectedIndex(2);
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1015, 400, 110, 40));
        ...
        jPanel1.add(enterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1015, 300, 110, 40));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1015, 350, 110, 40));
    ...
    private void dbaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbaseActionPerformed
        DBSuplidor dbView = new DBSuplidor();
        dbView.sql = this.sql;
    ...
    public void deleteSelectedItem(String nombre){
        ...
        String query = "Delete from Suplidor where SupNombre = '"+nombre+"'";
        try{
    ...
    public void CargarArticuloBuscado(String nombre){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from Suplidor where SupNombre = '"+nombre+"'";
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBSuplidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DBSuplidor().setVisible(true);
            }
        });
    }
