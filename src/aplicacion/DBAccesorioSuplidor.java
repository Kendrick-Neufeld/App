...
public class DBAccesorioSuplidor extends javax.swing.JFrame {
    ...
    public void deleteSelectedItem(String nombre){
        ...
        String query = "Delete from AccSuplidor where SupID = (select SupID from Suplidor where SupNombre = '"+nombre+"' )";
        try{
    ...
    public void CargarArticuloBuscado(String nombre){
        ...
        DefaultTableModel modelo = (DefaultTableModel) Tablas.getModel();
        modelo.setRowCount(0);
        String query = "select * from AccSuplidor where SupID = (select SupID from Suplidor where SupNombre = '"+nombre+"' )";
        try{
        res = sql.executeQuery(query);
        } catch(SQLException ex){
            System.out.println(ex);
