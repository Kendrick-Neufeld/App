 ...
 * @author Usuario
 */
public class DBFactura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(headerPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, -1));
        ...
        Tablas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Client", "Accesorio", "Dispositivo"
            }
        ));
        Tablas.setRowHeight(30);
        jScrollPane1.setViewportView(Tablas);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, 630, 340));
        ...
        jPanel1.add(facturaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 230, 40));
        ...
        jPanel1.add(selectLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 110, 100, 30));
        ...
        selectTableCombobox.setSelectedIndex(6);
        selectTableCombobox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectTableComboboxActionPerformed(evt);
            }
        });
        jPanel1.add(selectTableCombobox, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 150, 180, 40));
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(915, 410, 110, 40));
        ...
        jPanel1.add(searchLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 210, 60, 30));
        ...
        jPanel1.add(searchBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 240, 180, 40));
    ...
    private void dbaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbaseActionPerformed
        DBFactura dbView = new DBFactura();
        dbView.sql = this.sql;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
